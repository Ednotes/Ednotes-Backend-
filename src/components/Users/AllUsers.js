import { Box, Text, Flex, SimpleGrid, Image, Spacer, useDisclosure } from '@chakra-ui/react';
...
export default function AllUsers() {
	...
	return (
		<Box mt={-100} ml={-14} w="65vw">
			<CustomHeader title="All Users(222)" filterButtonOnClick={filterDisclosure.onOpen} />
